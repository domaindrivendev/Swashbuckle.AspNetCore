...
namespace Swashbuckle.AspNetCore.SwaggerUi
{
    public class SwaggerUiMiddleware
    {
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            var template = _options.IndexConfig.IndexTemplateStreamFactory?.Invoke() ?? _resourceAssembly.GetManifestResourceStream("Swashbuckle.AspNetCore.SwaggerUi.CustomAssets.index.html");
