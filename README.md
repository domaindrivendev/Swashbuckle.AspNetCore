...
|[5.2.1](https://github.com/domaindrivendev/Swashbuckle.AspNetCore/tree/v5.2.1)|>= 2.0.0|2.0, 3.0|3.25.0|2.0.0-rc.23|
...
1. Install the standard Nuget package into your ASP.NET Core application.
    ...
    ```
    Package Manager : Install-Package Swashbuckle.AspNetCore -Version 5.2.1
    CLI : dotnet add package --version 5.2.1 Swashbuckle.AspNetCore
    ```
...
```
Package Manager : Install-Package Swashbuckle.AspNetCore.Newtonsoft -Version 5.2.1
CLI : dotnet add package --version 5.2.1 Swashbuckle.AspNetCore.Newtonsoft
```
...
2. Install the Swashbuckle CLI tool and add it to the local manifest file
    ...
    ```
    dotnet tool install --version 5.2.1 Swashbuckle.AspNetCore.Cli
    ```
