...
namespace Swashbuckle.AspNetCore.SwaggerGen.Test
{
    public class XmlCommentsParameterFilterTests
    {
        ...
        {
            var parameter = new OpenApiParameter { Schema = new OpenApiSchema { Type = JsonSchemaType.String } };
            ...
            Assert.Equal("\"Example for \\\"param1\\\"\"", parameter.Example.ToJsonString());
        }
        ...
        public void Apply_SetsDescriptionAndExample_FromUriTypeActionParamTag()
        {
            ...
            Assert.NotNull(parameter.Example);
            Assert.Equal("\"http://test.com/?param1=1&param2=2\"", parameter.Example.ToJsonString());
        }
        ...
        {
            var parameter = new OpenApiParameter { Schema = new OpenApiSchema { Type = JsonSchemaType.String, Description = "schema-level description" } };
            ...
            Assert.NotNull(parameter.Example);
            Assert.Equal("\"Example for StringProperty\"", parameter.Example.ToJsonString());
        }
        ...
        public void Apply_SetsDescriptionAndExample_FromUriTypePropertySummaryAndExampleTags()
        {
            ...
            Assert.Null(parameter.Schema.Description);
            Assert.NotNull(parameter.Example);
            Assert.Equal("\"https://test.com/a?b=1&c=2\"", parameter.Example.ToJsonString());
        }
